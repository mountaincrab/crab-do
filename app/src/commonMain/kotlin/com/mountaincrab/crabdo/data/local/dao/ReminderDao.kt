...
interface ReminderDao {
    ...
    suspend fun updateNextTrigger(reminderId: String, nextTriggerMillis: Long, updatedAt: Long = currentTimeMillis())

    @Query("UPDATE reminders SET isDeleted = 1, updatedAt = :updatedAt, syncStatus = 'PENDING' WHERE id = :reminderId")
    suspend fun softDelete(reminderId: String, updatedAt: Long = currentTimeMillis())
    ...
    suspend fun markCompleted(reminderId: String, completedAt: Long = currentTimeMillis(), updatedAt: Long = currentTimeMillis())
}
